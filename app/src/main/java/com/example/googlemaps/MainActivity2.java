        ...
        implements OnMapReadyCallback, Asynchtask
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtLatitud = findViewById(R.id.txtLtt);
        txtLongitud = findViewById(R.id.txtLng);
        sliderRadio = findViewById(R.id.sliderRadio);

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapquevedo);mapFragment.getMapAsync(this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        updateInterfaz(); // Call to load initial markers
    ...
    public void processFinish(String result) throws JSONException {
        ...
        try {
            ...
            // Handle JSON parsing error, e.g., log the error or show a message to the user.
        }
    }
}
